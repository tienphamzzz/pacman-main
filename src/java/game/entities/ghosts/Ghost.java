...
public abstract class Ghost extends MovingEntity {
    ...
    public Ghost(int xPos, int yPos, String spriteName) {
        ...
        try {
            frightenedSprite1 = ImageIO.read(new File("assets/img/ghost_frightened.png"));
            frightenedSprite2 = ImageIO.read(new File("assets/img/ghost_frightened_2.png"));
            eatenSprite = ImageIO.read(new File("assets/img/ghost_eaten.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
